...
python test.py --dataset_root /datasets/graspnet --camera realsense \
    --checkpoint_path logs/gsnet_resunet_vanilla_cosine_anealing_n15k/gsnet_resunet_epoch13.tar \
    --dump_dir dumps/realsense_dev --batch_size 1 --infer --eval --backbone resunet --num_point 15000