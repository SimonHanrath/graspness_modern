...
python test.py --dataset_root /datasets/graspnet --camera realsense \
    --checkpoint_path logs/gsnet_resunet_vanilla_bigger_fields/gsnet_resunet_epoch12.tar \
    --dump_dir dumps/realsense_dev --batch_size 1 --infer --eval --backbone resunet --enable_stable_score